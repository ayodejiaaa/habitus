    ...
    <div className="bg-white border border-red-100 rounded-xl p-8 max-w-xl mx-auto my-12 text-center space-y-6 shadow-sm">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-500 max-w-sm mx-auto">
          We encountered an error loading this dashboard section. This is likely due to a database connection failure. Please make sure your database server is running.
        </p>
        {error.message && (
